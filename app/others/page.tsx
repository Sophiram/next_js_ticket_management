    ...
    const handlePrint = async () => {
        ...
        try {
            const res = await fetch("/api/tickets", {
                ...
                body: JSON.stringify({ action: "create", category: "ផ្សេងៗ" }),
            });
    ...
    return (
        <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4 font-khmer relative">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg text-center max-w-sm w-full space-y-4">
                <h2 className="text-xl font-bold text-slate-800">សេវាកម្មផ្សេងៗ</h2>
                <p className="text-gray-500 text-sm leading-relaxed">
                    សេវាកម្មទូទៅ និងការសាកសួរព័ត៌មានផ្សេងៗ
                </p>
                <button
                    onClick={handlePrint}
                    disabled={loading}
